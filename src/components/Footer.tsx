...
export default function Footer() {
  return (
    <footer className="border-t theme-section" style={{ borderColor: 'var(--border)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-5 sm:gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-sm foreground-text">
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
            {['#about', '#projects', '#skills', '#journey', '#contact']?.map((href) => (
              <a
                key={href}
                href={href}
                className="font-mono text-[10px] tracking-widest uppercase transition-colors duration-200 muted-text hover-primary"
              >
                {href?.replace('#', '')}
              </a>
            ))}
          ...
          <div className="flex flex-wrap items-center gap-4 sm:gap-5">
            <a
              ...
              aria-label="GitHub"
              className="transition-colors duration-200 muted-text hover-primary"
            >
            ...
            <p className="font-mono text-[10px] whitespace-nowrap muted-text">
