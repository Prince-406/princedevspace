...
export default function Footer() {
  return (
    <footer className="border-t" style={{ backgroundColor: 'var(--background)', borderColor: 'var(--border)' }}>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-5 sm:gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono text-sm" style={{ color: 'var(--foreground)' }}>
              prince<span style={{ color: 'var(--primary)' }}>.dev</span>
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4 sm:gap-5">
            ...
            <p className="font-mono text-[10px] whitespace-nowrap" style={{ color: 'var(--muted-foreground)' }}>
